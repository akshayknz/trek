    ...
    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <!--  <button id="<?php echo $data[$i]->id; ?>-getDeparture" onclick="getModalDeparture(this.id)" class="btn btn-info"data-toggle="modal" data-target="#exampleModalDeparture"><i class="far fa-clock"></i></button> -->&nbsp;&nbsp;
