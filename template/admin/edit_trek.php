    ...
    ?>
     ...
     <div class="main">
         ...
         <span class="pull-right" style="margin-top: 20px; margin-right: 10px;"> <a class="btn btn-success"
                 ...
                 target="_blank" role="button">Preview</a></span>
                                     ...
                                     <!-- <div class="col-md-4">
                                      ...
                                      <div class="col-md-3">
                                         <div class="form-group">
                                            ...
                                            <input id="trek_trail_type" type="text" value="<?php echo $data[0]->trek_trail_type; ?>"
                                                class="form-control"
                                     ...
                                     <div class="col-md-3">
                                         <div class="form-group"><label>Distance
                                                 *</label> <input id="trek_distance" type="number" class="form-control"
                                                 onchange="autoGenerateOverview()"
                                                 value="<?php echo $data[0]->trek_distance ?>" placeholder="Distance *"
                                                 required="required" data-error="required.">
                                         </div>
                                     </div>
                                     <div class="col-md-3">
                                 ...
                                 <div class="row col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group"><label>Fitness Required
                                                *</label> <input id="trek_fitness_required" type="text"
                                                class="form-control"  value="<?= $data[0]->trek_fitness ?>"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group"><label>Video url(Youtube)
                                                *</label> <input id="trek_about_video" type="text" value="<?= $data[0]->trek_video_about_url ?>"
                                                class="form-control"
                                 ...
                                 <div class="row col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group"><label>Suitable For
                                                *</label> <input id="trek_suitable_for" type="text" value="<?= $data[0]->trek_suitable ?>"
                                                 class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group"><label>Experience
                                                *</label> <input id="trek_experience" type="text" value="<?= $data[0]->trek_experience ?>"
                                                class="form-control"
 ...
 --><label>Upload Images (All Field Required) *</label>
                                     <div class="row col-md-12 gallery-container">
                                             ...
                                             <div class="col-md-3 card gallarybox1">
                                                 ...
                                                 <hr>
                                                 <div id="pe2" style="align-items: center;"></div><br>
                                             ...
                                             <div class="col-md-3 card gallarybox2">
                                                 ...
                                                 <hr>
                                                 <div id="ge2" style="display: flex;flex-wrap: wrap;"></div><br>
                                             ...
                                             <div class="col-md-3 card gallarybox3">
                                                 ...
                                                 <hr>
                                                 <div id="se2" style="display: flex;flex-wrap: wrap;"></div><br>
                                              ...
                                              <div class="col-md-3 card gallarybox4">
                                                 ...
                                                 <!-- <i>Choose multiple images</i><br> -->
                                                 <hr>
                                                 <div id="le2" style="display: flex;flex-wrap: wrap;"></div><br>
                                         ...
                                         <div class="col-md-3">
                                             <div class="form-group"><label>Food</label>
                                                 <input id="trek_food" type="text" class="form-control"
                                                     value="<?php echo $data[0]->trek_food ?>" placeholder="Enter Food"
                                                     required="required" data-error="required.">
                                             </div>
                                         </div>
                                        <!--  <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group"><label>Trek From *</label>
                                                <input id="trek_filter_from" type="text" class="form-control"
                                                    placeholder="Trek starts from" value="<?= $data[0]->trek_filter_from ?>"  required="required" data-error="required.">
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-group"><label>Trek To *</label>
                                                <input id="trek_filter_to" type="text" class="form-control"
                                                    placeholder="Trek to" value="<?= $data[0]->trek_filter_to ?>"  required="required" data-error="required.">
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-md-3">
                                            <div class="form-group"><label>Discount Percentage</label>
                                                <input id="trek_discount_percentage" type="number" class="form-control"
                                                    placeholder="Example: 30 , (Must be less than 100)" value="<?= $data[0]->trek_discount_percentage ?>" required="required" data-error="required.">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group"><label>Discount Upto</label>
                                                <input id="trek_discount_end_date" type="date" class="form-control"
                                                    placeholder="Example : 30th June" required="required" value="<?= $data[0]->trek_discount_end_date ?>" data-error="required.">
                                            </div>
                                        </div>
                                     ...
                                     <div class="row col-md-12">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span id="trek_cost_terms_error" style="display: none;color: red;">This
                                                    Field is Required *</span>
                                                <textarea class="form-control" id="trek_cost_terms_cancellation" rows="3">
                                                      <?php
