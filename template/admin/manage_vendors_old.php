...
<!--                                                   id="--><?php //echo $data[$i]->ven_id; ?><!--" role="button"-->
<!--                                                   data-toggle="modal"-->
            ...
            <div style="margin: 15px">
                ...
                <select name="treks" id="treks" style="width: 255px;height: 5px;">
                    ...
                    foreach ($users as $user) {
                        ...
                        <option id="<?php echo $user->id ?>"><?php echo $user->display_name; ?></option>
            ...
            <div style="margin: 15px">
                ...
                <select name="treks" id="treks" style="width: 255px;height: 5px;">
                    ...
                    foreach ($users as $user) {
                        ...
                        <option id="<?php echo $user->user_email; ?>"><?php echo $user->display_name; ?></option>
