...
for ($i = 0; $i < $count; $i++) {
    ...
    ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $j; ?></td>
                            <td><?php echo $data[$i]->trek_flag_name; ?></td>
                            <td class="text-center"><?php echo $data[$i]->trek_flag_updated_time; ?></td>
                            <td class="text-center"><a class="btn btn-info" onclick="flagEdit(this.id)"
                                    id="<?php echo $data[$i]->id; ?>-manageInv" role="button"
                                    href="admin.php?page=manage_maintenanceblock&num=<?php echo $data[$i]->id; ?>"><i
                                        class="fas fa-box-open"></i>&nbsp;&nbsp;Manage Inventory</a>
