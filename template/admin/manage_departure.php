...
if (isset($_GET['num'])) {
    ...
    $data = $wpdb->get_results('SELECT * FROM ' . $table_prefix . 'trektable_trek_departure where trek_departure_status!=1 and trek_selected_trek=' . $ppc . ' order by trek_start_date asc');
...
<div class="row col-md-12 col-lg-12 col-xl-12">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item active" role="presentation">
            <a class="nav-link  text-light bg-dark" id="home-tab" data-toggle="tab" href="#home" role="tab"
                aria-controls="home" aria-selected="true">Upcoming departures</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                aria-selected="false">Previous departures</a>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade in active" id="home" role="tabpanel" aria-labelledby="home-tab"
            style="background-color: #3C87AB;">
            <div style="display: flex; padding: 4px;flex-wrap: wrap; column-gap: 40px;justify-content: center;">
        ...
        for ($k = 0; $k < $count; $k++) {
            ...
            <div class="card cds" id="<?php echo $data[$k]->id ?>-cardTrek" data-show="<?= $data[$k]->trek_departure_status ?>">

                <div>
                    <?php echo $k2 . ' - ' . $l2 . ':' . $m2; ?>
                    <?php if(isset($data[$k]->dep_event_name)){ ?>
                    <div class="badge badge-success" style="margin-left: 20px;background-color: green;">
                        <?= $data[$k]->dep_event_name ?>
                    </div>
                    <?php }?>
                    <span class="editors-dep">
                        <i class="fas fa-edit dep-edit" id="<?php echo $data[$k]->id ?>-edit"
                            onclick="editDeparture(this.id)" data-toggle="modal" data-target="#exampleModalEdit">
                        </i>
                        <i class="fas fa-trash-alt dep-delete" id="<?php echo $data[$k]->id ?>-delete"
                            onclick="deleteDeparture(this.id)">
                        </i>
                    </span>
                </div>
            </div>
        ...
        ?>
        <span class="nothing-found">No departures found.</span>
        </div>
        </div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" id="departure-show"
                        style="transform: scale(1.7);margin: 0px 7px 4px 0px;outline: 0;">
                        <label class="form-check-label" for="departure-show">
                            Hide this date
                        </label>
                    </div>
