...
<body style="margin:20px auto">
   ...
   <!--   <button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModal_create_advisor">Add Advisor</button> --><br>
        ...
        <div style="margin: 20px;padding: 20px;">
             <div class="row">
                    ...
                    <span class="editors-dep video-rev-action"><i class="fas fa-edit" style="color: black;cursor: pointer;"
                        data-toggle="modal" data-target="#exampleModal_edit_advisor" id="<?php echo $founder[$i]->id; ?>" onclick="EditTeamMemberFetch(this.id)"></i>&nbsp;&nbsp;<i
                        class="fas fa-trash" style="color: red;cursor: pointer;" id="<?php echo $founder[$i]->id; ?>" onclick="deletePeople(this.id)">&nbsp;&nbsp;</i></span>
                    </div>&nbsp;&nbsp;
        ...
        <div class="col-md-6" style="min-height: 280px; background-color: #D0D9EA; ">
            ...
            <div class="row advisors-row alc">
                ...
                <div class="card clsd">
                    ...
                    <span class="editors-dep video-rev-action"><i class="fas fa-edit" style="color: black;cursor: pointer;"
                        data-toggle="modal" data-target="#exampleModal_edit_advisor" id="<?php echo $team[$i]->id; ?>" onclick="EditTeamMemberFetch(this.id)"></i>&nbsp;&nbsp;<i
                        class="fas fa-trash" style="color: red;cursor: pointer;" id="<?php echo $team[$i]->id; ?>" onclick="deletePeople(this.id)">&nbsp;&nbsp;</i></span>
                </div>
              <?php  
          }
              ?>
               ...
               <div class="col-md-12">
                <?php
                  ...
                  <div class="card clsd">
                    ...
                    <span class="editors-dep video-rev-action"><i class="fas fa-edit" style="color: black;cursor: pointer;"
                        data-toggle="modal" data-target="#exampleModal_edit_advisor" id="<?php echo $advisor[$i]->id; ?>" onclick="EditTeamMemberFetch(this.id)"></i>&nbsp;&nbsp;<i
                        class="fas fa-trash" style="color: red;cursor: pointer;" id="<?php echo $advisor[$i]->id; ?>" onclick="deletePeople(this.id)">&nbsp;&nbsp;</i></span>
                </div>
