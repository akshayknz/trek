...
$data = $wpdb->get_results('SELECT * FROM ' . $table_prefix . 'trektable_trek_brochure order by is_activated ASC');
...
<button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add Brochure
</button>
<div class="container">
        ...
        <div class="table-responsive">
            <table id="myTable" class="table table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center">Brochure Name</th>
                            ...
                            <?php   
                               ...
                               id="<?php echo $data[$i]->id; ?>-BBDelete" role="button">Delete</a>
                                ...
                                <?php
                                    ...
                                    <a class="btn btn-warning" onclick="manageBrochure(this.id,'activate')"
                               id="<?php echo $data[$i]->id; ?>-BBDelete" role="button">Deactive</a>
                               <a class="btn btn-danger" onclick="manageBrochure(this.id,'delete')"
                               id="<?php echo $data[$i]->id; ?>-BBDelete" role="button">Delete</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add new Brochure</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Brochure name:</label>
                    ...
                    <button type="button" name="submit" onclick="addmenuBrochure()" class="btn btn-primary">Add
                    </button>
