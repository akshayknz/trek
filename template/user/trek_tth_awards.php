...
<body style="margin:20px auto">
        ...
        <div class="row">
            <div class="col-md-6 award-images-container">
                    ...
                    <div class="row header"
                        ...
                        <h3>Uploaded Awards</h3><span class="award-images-add-new">  <button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add new Certification</button></span>
                    </div>
                ...
                <div class="row col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="card cds">
                        ...
                        <div style="margin-top: 10px;text-align: center;"><span style="float: left;"><img src="<?php echo $certification[$i]->trek_tth_award_image; ?>" style ="max-width: 200px;max-height: 100px;">&nbsp;&nbsp;&nbsp;
                                    </span><span
                                class="editors-dep"><i class="fas fa-trash" onclick="deleteAward(this.id)" id="<?php echo $certification[$i]->id; ?>" style="color: red;cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;</i></span></div>
                    </div><br><br>
            ...
            <div class="col-md-6 award-recoginition-container">
                    ...
                    <div class="row header"
                        style="text-align:center;color:black;margin-left: 20px;margin-top: 10px;padding: 5px;">
                        <h3>Recoginition</h3><span class="award-images-add-new">  <button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModalrecognition">Add new Recoginition</button></span>
                    </div>
                ...
                <div class="row col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="card cds">
                        ...
                        <div style="margin-top: 10px;text-align: center;"><span style="float: left;"><img src="<?php echo $recoginition[$i]->trek_tth_award_image; ?>" style ="max-width: 200px;max-height: 100px;" id="recoginition_image_<?php echo $recoginition[$i]->id; ?>">&nbsp;&nbsp;&nbsp;
                                    </span>
                                  
                                      
                                   
                                    <span
                                class="editors-dep"><i class="fas fa-edit award-edit" data-toggle="modal" data-target="#exampleModalrecognitionEdit" id="<?php echo $recoginition[$i]->id; ?>"  onclick="EditAwardFetch(this.id)"></i>&nbsp;&nbsp;<i class="fas fa-trash" onclick="deleteAward(this.id)" style="color: red;cursor: pointer;" id="<?php echo $recoginition[$i]->id; ?>">&nbsp;&nbsp;&nbsp;&nbsp;</i></span></div>
                                  <textarea id="recoginition_breif_<?php echo $recoginition[$i]->id; ?>" hidden><?php echo $recoginition[$i]->trek_tth_brief; ?></textarea>
                                  <input type="text" id="recoginition_priority_<?php echo $recoginition[$i]->id; ?>" value="<?php echo $recoginition[$i]->trek_tth_award_priority; ?>" style="display: none;">
   ...
   <div class="modal fade" id="exampleModalrecognition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add New Recognitionz</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form>
                        <div class="form-group">
                          ...
                          <div hidden>
                            ...
                            <select class="form-control" name="tth-award-priority-rec-edit"  id="tth-award-priority-rec-edit">
                              <option value="1">1</option>
                              <option value="2">2</option>
                              <option value="3">3</option>
                              <option value="4">4</option>
