...
$data = $wpdb->get_results('SELECT * FROM ' . $table_prefix . 'trek_pages_tth_news order by trek_tth_news_priority ASC');
...
<body style="margin:20px auto">
    ...
    <div class="loader" id="loader">
     ...
     <button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModalInfo">Title - Info
    </button>
     <button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModalNews">Title - News
    </button>
    <button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add NewsLetter
    </button>
    <div class="container">
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $data[$i]->trek_tth_category; ?></td>
...
?>
                    ...
                    <form>
                         <div class="form-group">
                            ...
                            <select class="form-control" name="tth-news-category"  id="tth-news-category">
                              ...
                              <option value="info-video">TTH Info - Video</option>
    ...
    <div class="modal fade" id="exampleModalInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Trek Info Title</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Title:</label>
                            <input type="text" class="form-control" id="info-title-var" value="<?= $dataTitle[1]->trek_content ?>">
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" onclick="createTitle('info')" class="btn btn-primary">Add Info Title</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="exampleModalNews" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Trek News Title</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Title:</label>
                            <input type="text" class="form-control" id="news-title-var" value="<?= $dataTitle[0]->trek_content ?>">
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" onclick="createTitle('news')" class="btn btn-primary">Add News Title</button>
                </div>
            </div>
        </div>
    </div>
