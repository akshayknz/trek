...
<body style="margin:20px auto">
                  ...
                  <div class="row col-md-12 col-lg-12 col-xl-12">
                    <div class="card cds">
                        ...
                        <div style="margin-top: 10px;text-align: center;"><span style="float: left;"><i class="fas fa-envelope-open" style="color: black;cursor: pointer;">&nbsp;Mail-Id</i>&nbsp;&nbsp;&nbsp;
                                    </span><div id="tth_pages_mail"><?= $data[0]->trek_tth_mail ?></div><span data-toggle="modal" data-target="#exampleModal_edit_mail" onclick="edit_this_mail()" 
                    ...
                    <div class="card cds">
                        ...
                        <div style="margin-top: 10px;text-align: center;"><span style="float: left;"><i class="fas fa-phone-alt" style="color: black;cursor: pointer;">&nbsp;Phone - 1</i>&nbsp;&nbsp;&nbsp;
                                    </span><div id="tth_pages_c1"><?= $data[0]->trek_tth_c1 ?></div><span data-toggle="modal" data-target="#exampleModal_edit_phone1" onclick="edit_this_c1()"
                                class="editors-dep"><i class="fas fa-edit" style="color: black;cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;</i></span></div>
                    </div><br><br>
                    ...
                    <div class="card cds" style="background-color: #e8d49e;">
                        ...
                        <div style="margin-top: 10px;text-align: center;"><span style="float: left;"><i class="fas fa-phone-alt" style="color: black;cursor: pointer;">&nbsp;Working Hours</i>&nbsp;&nbsp;&nbsp;
                                    </span><div id="tth_pages_w1"><?= $data[0]->working_hours ?></div><span data-toggle="modal" data-target="#exampleModal_edit_working_hours" onclick="edit_this_w1()"
                                class="editors-dep"><i class="fas fa-edit" style="color: black;cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;</i></span></div>
                    </div><br><br>

                    <div class="card cds" style="background-color: #998f73;">

                        <div style="margin-top: 10px;text-align: center;"><span style="float: left;"><i class="fas fa-phone-alt" style="color: black;cursor: pointer;">&nbsp;Business</i>&nbsp;&nbsp;&nbsp;
                                    </span><div id="tth_pages_b1"><?= $data[0]->b_to_b_text ?></div><span data-toggle="modal" data-target="#exampleModal_edit_business" onclick="edit_this_b1()"
                                class="editors-dep"><i class="fas fa-edit" style="color: black;cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;</i></span></div>
                    </div><br><br>
   ...
   <div class="modal fade" id="exampleModal_edit_mail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="exampleModal_edit_working_hours" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
