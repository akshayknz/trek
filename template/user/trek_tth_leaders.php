...
$data = $wpdb->get_results('SELECT id, leader_name,leader_num1,leader_num2,leader_email FROM ' . $table_prefix . 'trektable_leaders');
...
<button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add New Leader
</button>
<div class="container">
            ...
            <table id="myTable" class="table table-striped">
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo $data[$i]->leader_email; ?></td>
                        <td style="text-align: center;"><?php echo $data[$i]->leader_num1; ?></td>
                        <td class="text-center"><?php echo $data[$i]->leader_num2; ?></td>
                        <td class="text-center"><a class="btn btn-info" onclick="updateLeaderFetch(<?php echo $data[$i]->id; ?>)"
                                                   id="<?php echo $data[$i]->id; ?>-NewsEdit" role="button"
                                                   data-toggle="modal"
                                                   data-target="#editModal">Edit</a>
                            <a class="btn btn-danger" onclick="deleteLeader(<?php echo $data[$i]->id; ?>)"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="createNewLeader()" class="btn btn-primary">Add</button>
            </div>
        </div>
    </div>
</div>
