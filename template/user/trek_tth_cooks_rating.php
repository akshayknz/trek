...
$data = $wpdb->get_results('SELECT rating.ID,cook_name, CookID,NoOfBatch,NoOfDays,Value,AddedDate FROM ' . $table_prefix . 'trektable_cookrating AS rating INNER JOIN ' . $table_prefix . 'trektable_cooks AS cook ON cook.id=rating.CookID WHERE Status=0 ORDER BY rating.ID DESC');
...
<button class="myButton btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add New Cook Rating
</button>
<div class="container">
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-danger" onclick="deleteCookRating(<?php echo $data[$i]->ID ?>)"
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Create New Cook Rating</h5>
    ...
    <input id="input-2" name="input-2" class="rating rating-loading" data-min="0" data-max="5" data-size="xs" data-step="1">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="createNewCookRating()" class="btn btn-primary">Add</button>
            </div>
        </div>
    </div>
</div>
